...
const Index = () => {
  ...
  const faqItems = [
    {
      question: 'Как происходит выдача товаров?',
      answer: 'Все товары выдаются автоматически через API сервера сразу после оплаты. Просто зайдите в игру и получите свою покупку!'
    },
    {
      question: 'Какие способы оплаты доступны?',
      answer: 'Мы принимаем банковские карты, электронные кошельки и криптовалюту. Все платежи проходят через защищенные системы.'
    },
    {
      question: 'Можно ли вернуть товар?',
      answer: 'Так как товары выдаются автоматически, возврат невозможен. Перед покупкой внимательно проверьте выбранный товар.'
    },
    {
      question: 'Как долго действует VIP статус?',
      answer: 'VIP статус действует 30 дней с момента активации. Вы можете продлить его в любое время.'
    }
  ];
